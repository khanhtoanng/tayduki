...
class _ActorOncomingMoviePageState extends State<ActorOncomingMoviePage> {
  ...
  @override
  void initState() {
    getUsername().then((username) => bloc.getAllIncomingDestiny(username));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarCustomize().setAppbar(context, 'Oncoming Movie', true),
      body: Container(child: getListIncomingDestiny(context)),
    );
  }

  StreamBuilder getListIncomingDestiny(context) {
    return StreamBuilder(
      stream: bloc.listIncomingStream,
